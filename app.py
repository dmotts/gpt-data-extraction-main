...
def extract_content_from_url(url: str):
    ...
    print(f"text_with_pytesseract: {text_with_pytesseract}")
    st.write(f"text_with_pytesseract: {text_with_pytesseract}")
...
def main():
    ...
    if uploaded_files is not None and data_points is not None:
        ...
        for file in uploaded_files:
            ...
            # !!! (dir='.', suffix='.csv', delete=False) THIS WILL CAUSE THE TEMP FILES NOT TO BE DELETED
            with NamedTemporaryFile(dir='.', suffix='.csv', delete=False) as f:
